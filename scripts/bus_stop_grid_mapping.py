"""
버스정류장 위치정보를 격자에 매핑하는 스크립트
- 입력: 01._격자_(4개_시·구).geojson, 19._버스정류장_위치정보.csv
- 출력: output/19._버스정류장_위치정보_격자매핑.csv
"""
...
BUS_STOP_FILE = os.path.join(DATA_DIR, '19._버스정류장_위치정보.csv')
OUTPUT_DIR = os.path.join(BASE_DIR, 'output')
OUTPUT_FILE = os.path.join(OUTPUT_DIR, '19._버스정류장_위치정보_격자매핑.csv')
...
def main():
    ...
    print(f"버스정류장 총 개수: {len(bus_stop_data):,}개\n")
    ...
    # 4. 매핑 수행
    result = map_data_to_grid(bus_stop_data, tree, polygons, gid_list, link_tree, link_ids)
