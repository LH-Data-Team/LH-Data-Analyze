"""
학교현황 데이터를 격자에 매핑하는 스크립트
- 입력: 01._격자_(4개_시·구).geojson, 15._학교현황.csv
- 출력: output/15._학교현황_격자매핑.csv
"""
...
SCHOOL_FILE = os.path.join(DATA_DIR, '15._학교현황.csv')
OUTPUT_DIR = os.path.join(BASE_DIR, 'output')
OUTPUT_FILE = os.path.join(OUTPUT_DIR, '15._학교현황_격자매핑.csv')
...
def main():
    ...
    print(f"학교 총 개수: {len(school_data):,}개\n")
    ...
    # 4. 매핑 수행
    result = map_data_to_grid(school_data, tree, polygons, gid_list, link_tree, link_ids)
