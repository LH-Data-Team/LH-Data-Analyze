...
CHILD_ZONE_FILE = os.path.join(BASE_DIR, '14._어린이보호구역.csv')
OUTPUT_DIR = os.path.join(BASE_DIR, 'output')
OUTPUT_FILE = os.path.join(OUTPUT_DIR, '어린이보호구역_격자매핑.csv')
...
def main():
    ...
    # 3. 매핑 수행
    result = map_data_to_grid(child_zone_data, tree, polygons, gid_list)
